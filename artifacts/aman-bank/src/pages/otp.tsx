...
export default function OtpPage() {
  ...
  const onChange = (v: string) => {
    ...
    setOtp(trimmed);
    if (submitted) setError(trimmed.length === 6 ? "" : "أدخل الرمز المكون من 6 أرقام");
  };
            ...
            <div style={{ marginBottom: 8 }}>
              <input
                ...
                style={{
                  ...
                  borderRadius: 16, border: `2.5px solid ${otp.length === 6 ? BLUE : submitted && error ? "#ef4444" : "#dde4f0"}`,
                  background: submitted && error && otp.length < 6 ? "#fff5f5" : "#f8faff",
                  color: BLUE, outline: "none", fontFamily: "monospace",
                  boxShadow: otp.length === 6 ? `0 4px 18px ${BLUE}35` : "none",
